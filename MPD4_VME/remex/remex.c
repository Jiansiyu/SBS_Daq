...
main(int argc, char *argv[]) {
	...
	switch (opt_param) 
	  ...
	  case 'l': /* use vmeBusLock/vmeBusUnlock */
	    useVmeBusLock=1;
	    if(Verbose) printf("-- Use vmeBUS Lock\n");
	    break;
    ...
    remexClientUseVmeBusLock(useVmeBusLock);
