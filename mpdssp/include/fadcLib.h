...
#define FA_SUPPORTED_PROC_FIRMWARE 0x910
...
struct fadc_struct 
{
  ...
  /* 0x01A0 */ volatile unsigned int spare_adc[(0x200-0x1A0)>>2];
...
#define FA_SUPPORTED_MODES            1,2,3,4,7,8
#define FA_SUPPORTED_NMODES                     6

extern const char *fa_mode_names[FA_ADC_PROC_MASK+1];
...
#define FA_ADC_MAX_PL       0x7ff
#define FA_ADC_MAX_PTW      0x1ff
#define FA_ADC_MAX_NSB      0xfff
#define FA_ADC_MAX_NSA      0xfff
#define FA_ADC_MAX_NP         0x3
...
#define FA_ADC_NSB_TRIGGERPATH_MASK 0x00001E00

#define FA_ADC_NSA_READBACK_MASK    0x000001FF
#define FA_ADC_NSA_TRIGGERPATH_MASK 0x00007E00

#define FA_ADC_MAX_NSB_TRIGGERPATH 31
#define FA_ADC_MAX_NSA_TRIGGERPATH 63

#define FA_ADC_DEFAULT_TRIGGERPATH_THRESHOLD 0
#define FA_ADC_MAX_TRIGGERPATH_THRESHOLD     4095
#define FA_ADC_TRIGGERPATH_THRESHOLD_MASK    0xFFF
...
int  faSetTriggerPathSamples(int id, unsigned int NSB, unsigned int NSA);
void faGSetTriggerPathSamples(unsigned int NSB, unsigned int NSA);
int  faSetTriggerPathThreshold(int id, unsigned int threshold);
void faGSetTriggerPathThreshold(unsigned int threshold);
