...
typedef struct
{
	...
	/* 0x002C-0x002F */          unsigned int Reserved3[(0x0030-0x002c)/4];
	/* 0x0030-0x0033 */ volatile unsigned int Avg;
	/* 0x0034-0x0037 */ volatile unsigned int ApvOffset;
	/* 0x0038-0x003B */ volatile unsigned int ApvThreshold;
	/* 0x003C-0x00FF */          unsigned int Reserved4[(0x0100-0x003c)/4];
} MPD_regs;

typedef struct
{
	/* 0x0000-0x0003 */ volatile unsigned int Status;
        /* 0x0004-0x0100 */          unsigned int Reserved0[(0x0100-0x0004)/4];
} MIG_regs;
...
#define SSP_INIT_MODE_VXSLOCAL         4
#define SSP_INIT_MODE_MASK             0x7
...
int  sspMpdSetAvg(int id, int fiber, int apv, int min, int max);
int  sspMpdSetApvOffset(int id, int fiber, int apv, int strip, int offset);
int  sspMpdSetApvThreshold(int id, int fiber, int apv, int strip, int threshold);
